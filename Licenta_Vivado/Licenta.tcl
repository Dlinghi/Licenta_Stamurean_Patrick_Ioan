...
#
# Licenta.tcl: Tcl script for re-creating project 'Licenta'
#
# Generated by Vivado on Sun Jun 09 17:19:12 +0300 2024
...
#
# 1. This project restoration tcl script (Licenta.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "C:/Users/patri/Desktop/Li/5/Licenta/Data_COE.coe"
#    "C:/Users/patri/Desktop/Li/5/Licenta/Address_COE.coe"
#    "C:/Users/patri/Desktop/Li/5/Licenta/Licenta.srcs/utils_1/imports/synth_1/Licenta_Design_wrapper.dcp"
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/../Li/5/Licenta/Data_COE.coe"]"\
 "[file normalize "$origin_dir/../Li/5/Licenta/Address_COE.coe"]"\
 "[file normalize "$origin_dir/../Li/5/Licenta/Licenta.srcs/utils_1/imports/synth_1/Licenta_Design_wrapper.dcp"]"\
  ]
  foreach ifile $files {
...
set orig_proj_dir "[file normalize "$origin_dir/../Li/5/Licenta"]"
...
set_property -name "board_part_repo_paths" -value "[file normalize "$origin_dir/../../AppData/Roaming/Xilinx/Vivado/2023.2.1/xhub/board_store/xilinx_board_store"]" -objects $obj
...
set_property -name "platform.name" -value "Licenta_Platform" -objects $obj
...
set file "Licenta/Address_COE.coe"
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "is_enabled" -value "1" -objects $file_obj
set_property -name "is_global_include" -value "0" -objects $file_obj
set_property -name "library" -value "xil_defaultlib" -objects $file_obj
...
\
  ...
  set_property -dict [list \
    ...
    CONFIG.C_ATG_SYSTEM_INIT_ADDR_MIF {c:/Users/patri/Desktop/Li/5/Licenta/Address_COE.coe} \
    CONFIG.C_ATG_SYSTEM_INIT_DATA_MIF {c:/Users/patri/Desktop/Li/5/Licenta/Data_COE.coe} \
  ...
  set_property CONFIG.C_SLOT_0_AXI_PROTOCOL {AXI3} $ila_1
  ...
  connect_bd_intf_net -intf_net axi_data_fifo_0_M_AXI [get_bd_intf_pins axi_data_fifo_0/M_AXI] [get_bd_intf_pins smartconnect_0/S00_AXI]
  connect_bd_intf_net -intf_net axi_dma_0_M_AXI_S2MM [get_bd_intf_pins axi_dma_0/M_AXI_S2MM] [get_bd_intf_pins axi_data_fifo_0/S_AXI]
  connect_bd_intf_net -intf_net axi_gpio_0_GPIO [get_bd_intf_ports btns_5bits] [get_bd_intf_pins axi_gpio_0/GPIO]
  connect_bd_intf_net -intf_net axi_gpio_1_GPIO2 [get_bd_intf_ports leds_8bits] [get_bd_intf_pins axi_gpio_1/GPIO2]
  connect_bd_intf_net -intf_net axi_gpio_2_GPIO [get_bd_intf_ports sws_8bits] [get_bd_intf_pins axi_gpio_2/GPIO]
  connect_bd_intf_net -intf_net axi_interconnect_0_M00_AXI [get_bd_intf_pins axi_timebase_wdt_0/S_AXI] [get_bd_intf_pins axi_interconnect_0/M00_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_0_M01_AXI [get_bd_intf_pins axi_timer_0/S_AXI] [get_bd_intf_pins axi_interconnect_0/M01_AXI]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M03_AXI [get_bd_intf_pins axi_interconnect_0/M03_AXI] [get_bd_intf_pins axi_dma_0/S_AXI_LITE]
  connect_bd_intf_net -intf_net axi_interconnect_0_M04_AXI [get_bd_intf_pins axi_interconnect_0/M04_AXI] [get_bd_intf_pins axi_gpio_1/S_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_0_M05_AXI [get_bd_intf_pins axi_interconnect_0/M05_AXI] [get_bd_intf_pins axi_gpio_2/S_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_0_M06_AXI [get_bd_intf_pins axi_traffic_gen_0/S_AXI] [get_bd_intf_pins axi_interconnect_0/M06_AXI]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets axi_traffic_gen_0_M_AXIS_MASTER] [get_bd_intf_pins axi_traffic_gen_0/M_AXIS_MASTER] [get_bd_intf_pins ila_0/SLOT_0_AXIS]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets smartconnect_0_M00_AXI] [get_bd_intf_pins smartconnect_0/M00_AXI] [get_bd_intf_pins ila_1/SLOT_0_AXI]
  ...
  connect_bd_net -net axi_gpio_2_gpio2_io_o [get_bd_pins axi_gpio_2/gpio2_io_o] [get_bd_pins axi_timebase_wdt_0/freeze]
  connect_bd_net -net axi_timebase_wdt_0_wdt_interrupt [get_bd_pins axi_timebase_wdt_0/wdt_interrupt] [get_bd_pins xlconcat_1/In0]
  connect_bd_net -net axi_timebase_wdt_0_wdt_reset [get_bd_pins axi_timebase_wdt_0/wdt_reset] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net axi_timer_0_generateout0 [get_bd_pins axi_timer_0/generateout0] [get_bd_pins axi_gpio_1/gpio_io_i]
  connect_bd_net -net axi_timer_0_interrupt [get_bd_pins axi_timer_0/interrupt] [get_bd_pins xlconcat_1/In1]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins axi_traffic_gen_0/s_axi_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_interconnect_0/M02_ACLK] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_timebase_wdt_0/s_axi_aclk] [get_bd_pins axi_interconnect_0/M01_ACLK] [get_bd_pins axi_timer_0/s_axi_aclk] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins axi_interconnect_0/M03_ACLK] [get_bd_pins axi_interconnect_0/M04_ACLK] [get_bd_pins ila_0/clk] [get_bd_pins axi_data_fifo_0/aclk] [get_bd_pins smartconnect_0/aclk] [get_bd_pins ila_1/clk] [get_bd_pins axi_gpio_1/s_axi_aclk] [get_bd_pins axi_interconnect_0/M05_ACLK] [get_bd_pins axi_gpio_2/s_axi_aclk] [get_bd_pins axi_interconnect_0/M06_ACLK]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_interconnect_0/M02_ARESETN] [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_timebase_wdt_0/s_axi_aresetn] [get_bd_pins axi_interconnect_0/M01_ARESETN] [get_bd_pins axi_timer_0/s_axi_aresetn] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axi_interconnect_0/M03_ARESETN] [get_bd_pins axi_data_fifo_0/aresetn] [get_bd_pins axi_interconnect_0/M04_ARESETN] [get_bd_pins axi_gpio_1/s_axi_aresetn] [get_bd_pins axi_interconnect_0/M05_ARESETN] [get_bd_pins axi_gpio_2/s_axi_aresetn] [get_bd_pins axi_interconnect_0/M06_ARESETN]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins xlconcat_0/dout] [get_bd_pins axi_traffic_gen_0/s_axi_aresetn]
  ...
  set_property PFM_NAME {xilinx:zedboard:Licenta_Platform:0.0} [get_files [current_bd_design].bd]
...
set_property PFM_NAME "xilinx:zedboard:Licenta_Platform:0.0" [get_files Licenta_Design.bd ] 
...
if { [get_property IS_LOCKED [ get_files -norecurse [list Licenta_Design.bd]] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/../Li/5/Licenta/Licenta.gen/sources_1/bd/Licenta_Design/hdl/Licenta_Design_wrapper.vhd" ]
} else {
...
set_property -name "incremental_checkpoint" -value "$proj_dir/Licenta.srcs/utils_1/imports/synth_1/Licenta_Design_wrapper.dcp" -objects $obj
...
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/Licenta.srcs/utils_1/imports/synth_1" -objects $obj
...
set_property -name "auto_rqs.directory" -value "$proj_dir/Licenta.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "incremental_checkpoint.more_options" -value "" -objects $obj
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/Licenta.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "min_rqa_score" -value "0" -objects $obj
