...
#
# Licenta_Stream_Vivado.tcl: Tcl script for re-creating project 'project_1'
#
# Generated by Vivado on Mon Aug 05 20:21:19 +0300 2024
...
#
# 1. This project restoration tcl script (Licenta_Stream_Vivado.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "C:/Users/patri/Desktop/LicentaStagii/6_GPIO/Vivado/project_1.srcs/constrs_1/new/axiuart.xdc"
#    "C:/Users/patri/Desktop/LicentaStagii/6_GPIO/Vivado/project_1.srcs/utils_1/imports/synth_1/Licenta_Design_wrapper.dcp"
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/LicentaStagii/6_GPIO/Vivado/project_1.srcs/constrs_1/new/axiuart.xdc"]"\
 "[file normalize "$origin_dir/LicentaStagii/6_GPIO/Vivado/project_1.srcs/utils_1/imports/synth_1/Licenta_Design_wrapper.dcp"]"\
  ]
  foreach ifile $files {
  ...
  set paths [list \
 "[file normalize "$origin_dir/LicentaStagii/6_GPIO/Vivado/[file normalize "$origin_dir/LicentaStagii/1/ip_repo/ImageFlip_1_0"]"]"\
 "[file normalize "$origin_dir/LicentaStagii/6_GPIO/Vivado/[file normalize "$origin_dir/LicentaStagii/1/ip_repo/ImageFlip_1_0"]"]"\
 "[file normalize "$origin_dir/LicentaStagii/6_GPIO/Vivado/[file normalize "$origin_dir/LicentaStagii/1/ip_repo/ImageFlip_1_0"]"]"\
 "[file normalize "$origin_dir/LicentaStagii/6_GPIO/Vivado/[file normalize "$origin_dir/LicentaStagii/1/ip_repo/ImageFlip_1_0"]"]"\
 "[file normalize "$origin_dir/LicentaStagii/6_GPIO/Vivado/[file normalize "$origin_dir/LicentaStagii/1/ip_repo/ImageFlip_1_0"]"]"\
 "[file normalize "$origin_dir/LicentaStagii/6_GPIO/Vivado/[file normalize "$origin_dir/LicentaStagii/1/ip_repo/ImageFlip_1_0"]"]"\
 "[file normalize "$origin_dir/LicentaStagii/6_GPIO/Vivado/[file normalize "$origin_dir/LicentaStagii/1/ip_repo/ImageFlip_1_0"]"]"\
 "[file normalize "$origin_dir/LicentaStagii/6_GPIO/Vivado/[file normalize "$origin_dir/LicentaStagii/1/ip_repo/EdgeDetector_1_0"]"]"\
 "[file normalize "$origin_dir/LicentaStagii/6_GPIO/Vivado/[file normalize "$origin_dir/LicentaStagii/1/ip_repo/EdgeDetection_1_0"]"]"\
 "[file normalize "$origin_dir/LicentaStagii/6_GPIO/Vivado/[file normalize "$origin_dir/LicentaStagii/1/ip_repo/EdgeDetection_1_0"]"]"\
  ]
  foreach ipath $paths {
...
set script_file "Licenta_Stream_Vivado.tcl"
...
set orig_proj_dir "[file normalize "$origin_dir/LicentaStagii/6_GPIO/Vivado"]"
...
set_property -name "platform.name" -value "VideoPlatform" -objects $obj
...
if { $obj != {} } {
   set_property "ip_repo_paths" "[file normalize "$origin_dir/LicentaStagii/1/ip_repo/ImageFlip_1_0"] [file normalize "$origin_dir/LicentaStagii/1/ip_repo/ImageFlip_1_0"] [file normalize "$origin_dir/LicentaStagii/1/ip_repo/ImageFlip_1_0"] [file normalize "$origin_dir/LicentaStagii/1/ip_repo/ImageFlip_1_0"] [file normalize "$origin_dir/LicentaStagii/1/ip_repo/ImageFlip_1_0"] [file normalize "$origin_dir/LicentaStagii/1/ip_repo/ImageFlip_1_0"] [file normalize "$origin_dir/LicentaStagii/1/ip_repo/ImageFlip_1_0"] [file normalize "$origin_dir/LicentaStagii/1/ip_repo/EdgeDetector_1_0"] [file normalize "$origin_dir/LicentaStagii/1/ip_repo/EdgeDetection_1_0"] [file normalize "$origin_dir/LicentaStagii/1/ip_repo/EdgeDetection_1_0"]" $obj
...
set_property -name "top" -value "Licenta_Design_wrapper" -objects $obj
...
set file "[file normalize "$origin_dir/LicentaStagii/6_GPIO/Vivado/project_1.srcs/constrs_1/new/axiuart.xdc"]"
set file_imported [import_files -fileset constrs_1 [list $file]]
set file "new/axiuart.xdc"
...
set_property -name "target_constrs_file" -value "[get_files [list "*new/axiuart.xdc"]]" -objects $obj
set_property -name "target_ucf" -value "[get_files [list "*new/axiuart.xdc"]]" -objects $obj
...
set file "synth_1/Licenta_Design_wrapper.dcp"
...
# Proc to create BD Licenta_Design
proc cr_bd_Licenta_Design { parentCell } {

  # CHANGE DESIGN NAME HERE
  set design_name Licenta_Design
...
\
  ...
  # Create instance: ImageFlip_0, and set properties
  set ImageFlip_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:ImageFlip:1.0 ImageFlip_0 ]
  ...
  set_property CONFIG.ENABLE_WINDOW_WDT {0} $axi_timebase_wdt_0
  ...
  connect_bd_intf_net -intf_net ImageFlip_0_M00_AXIS [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins ImageFlip_0/M00_AXIS]
  ...
  connect_bd_intf_net -intf_net axis_data_fifo_0_M_AXIS [get_bd_intf_pins ImageFlip_0/S00_AXIS] [get_bd_intf_pins axis_data_fifo_0/M_AXIS]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins ps7_0_axi_periph/M01_AXI] [get_bd_intf_pins axi_timebase_wdt_0/S_AXI]
  ...
  connect_bd_net -net axi_gpio_0_gpio2_io_o [get_bd_pins axi_gpio_0/gpio2_io_o] [get_bd_pins axis_data_fifo_0/m_axis_tready]
  connect_bd_net -net axi_timebase_wdt_0_wdt_interrupt [get_bd_pins axi_timebase_wdt_0/wdt_interrupt] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins axis_data_fifo_0/s_axis_aclk] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_interconnect_0/S01_ACLK] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins ImageFlip_0/m00_axis_aclk] [get_bd_pins ImageFlip_0/s00_axis_aclk] [get_bd_pins axi_timebase_wdt_0/s_axi_aclk] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins ps7_0_axi_periph/M02_ACLK]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins axis_data_fifo_0/s_axis_aresetn] [get_bd_pins axi_interconnect_0/S01_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins ImageFlip_0/m00_axis_aresetn] [get_bd_pins ImageFlip_0/s00_axis_aresetn] [get_bd_pins axi_timebase_wdt_0/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M02_ARESETN]
  ...
  regenerate_bd_layout -layout_string {
   ...
   "Color Coded_Layout":"# # String gsaved with Nlview 7.7.1 2023-07-26 3bc4126617 VDI=43 GEI=38 GUI=JA:21.0
#  -string -flagsOSRD
preplace port DDR -pg 1 -lvl 7 -x 2240 -y 450 -defaultsOSRD
preplace port FIXED_IO -pg 1 -lvl 7 -x 2240 -y 470 -defaultsOSRD
preplace port sws_8bits -pg 1 -lvl 7 -x 2240 -y 660 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 6 -x 1970 -y 520 -defaultsOSRD
preplace inst axi_dma_0 -pg 1 -lvl 4 -x 1220 -y 470 -defaultsOSRD
preplace inst axi_interconnect_0 -pg 1 -lvl 5 -x 1580 -y 500 -defaultsOSRD
preplace inst axis_data_fifo_0 -pg 1 -lvl 2 -x 550 -y 480 -defaultsOSRD
preplace inst rst_ps7_0_100M -pg 1 -lvl 1 -x 200 -y 450 -defaultsOSRD
preplace inst ps7_0_axi_periph -pg 1 -lvl 3 -x 870 -y 180 -defaultsOSRD
preplace inst xlconcat_0 -pg 1 -lvl 5 -x 1580 -y 230 -defaultsOSRD
preplace inst ImageFlip_0 -pg 1 -lvl 3 -x 870 -y 470 -defaultsOSRD
preplace inst axi_timebase_wdt_0 -pg 1 -lvl 4 -x 1220 -y 210 -defaultsOSRD
preplace inst axi_gpio_0 -pg 1 -lvl 2 -x 550 -y 690 -defaultsOSRD
preplace netloc axi_dma_0_mm2s_introut 1 4 1 1390 230n
preplace netloc axi_dma_0_s2mm_introut 1 4 1 1400 250n
preplace netloc axi_gpio_0_gpio2_io_o 1 2 1 700 490n
preplace netloc axi_timebase_wdt_0_wdt_interrupt 1 4 1 N 210
preplace netloc processing_system7_0_FCLK_CLK0 1 0 7 30 550 380 590 710 370 1040 600 1430 650 1760 390 2180
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 7 20 350 NJ 350 NJ 350 NJ 350 NJ 350 NJ 350 2200
preplace netloc rst_ps7_0_100M_peripheral_aresetn 1 1 4 370 600 730 570 1060 590 1440
preplace netloc xlconcat_0_dout 1 5 1 1720 230n
preplace netloc ImageFlip_0_M00_AXIS 1 3 1 1050 440n
preplace netloc S00_AXI_1 1 4 1 N 410
preplace netloc axi_dma_0_M_AXIS_MM2S 1 1 4 390 340 NJ 340 NJ 340 1380
preplace netloc axi_dma_0_M_AXI_S2MM 1 4 1 N 430
preplace netloc axi_gpio_0_GPIO 1 2 5 730J 660 NJ 660 NJ 660 NJ 660 N
preplace netloc axi_interconnect_0_M00_AXI 1 5 1 N 500
preplace netloc axis_data_fifo_0_M_AXIS 1 2 1 720 430n
preplace netloc processing_system7_0_DDR 1 6 1 NJ 450
preplace netloc processing_system7_0_FIXED_IO 1 6 1 NJ 470
preplace netloc processing_system7_0_M_AXI_GP0 1 2 5 730 20 NJ 20 NJ 20 NJ 20 2190
preplace netloc ps7_0_axi_periph_M00_AXI 1 3 1 1050 160n
preplace netloc ps7_0_axi_periph_M01_AXI 1 3 1 N 180
preplace netloc ps7_0_axi_periph_M02_AXI 1 1 3 400 360 NJ 360 1010
levelinfo -pg 1 0 200 550 870 1220 1580 1970 2240
pagesize -pg 1 -db -bbox -sgen 0 0 2400 780
",
   "Color Coded_ScaleFactor":"0.794861",
   "Color Coded_TopLeft":"8,-123",
   "Default View_ScaleFactor":"0.719061",
   "Default View_TopLeft":"142,-4",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.7.1 2023-07-26 3bc4126617 VDI=43 GEI=38 GUI=JA:21.0
#  -string -flagsOSRD
preplace port DDR -pg 1 -lvl 6 -x 1990 -y 670 -defaultsOSRD
preplace port FIXED_IO -pg 1 -lvl 6 -x 1990 -y 690 -defaultsOSRD
preplace port mdio_rtl -pg 1 -lvl 6 -x 1990 -y 170 -defaultsOSRD
preplace port gmii_rtl -pg 1 -lvl 6 -x 1990 -y 190 -defaultsOSRD
preplace port port-id_reset_rtl -pg 1 -lvl 6 -x 1990 -y 250 -defaultsOSRD
preplace port port-id_sys_clock -pg 1 -lvl 0 -x 0 -y 510 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 5 -x 1730 -y 750 -defaultsOSRD
preplace inst axi_ethernet_0 -pg 1 -lvl 5 -x 1730 -y 190 -defaultsOSRD
preplace inst axi_ethernet_0_dma -pg 1 -lvl 3 -x 890 -y 180 -defaultsOSRD
preplace inst axi_ethernet_0_refclk -pg 1 -lvl 4 -x 1260 -y 510 -defaultsOSRD
preplace inst ps7_0_axi_periph -pg 1 -lvl 2 -x 540 -y 770 -defaultsOSRD
preplace inst rst_ps7_0_100M -pg 1 -lvl 1 -x 200 -y 1010 -defaultsOSRD
preplace inst axi_mem_intercon -pg 1 -lvl 4 -x 1260 -y 210 -defaultsOSRD
preplace netloc Net 1 0 6 20 830 370 620 690 340 1100 600 1470 890 1970
preplace netloc axi_ethernet_0_dma_mm2s_prmry_reset_out_n 1 3 2 1090 400 1420J
preplace netloc axi_ethernet_0_dma_mm2s_cntrl_reset_out_n 1 3 2 1080 410 1440J
preplace netloc axi_ethernet_0_dma_s2mm_prmry_reset_out_n 1 3 2 1070 420 1460J
preplace netloc axi_ethernet_0_dma_s2mm_sts_reset_out_n 1 3 2 1060 430 1480J
preplace netloc axi_ethernet_0_refclk_clk_out1 1 4 1 1500 300n
preplace netloc axi_ethernet_0_refclk_clk_out2 1 4 1 1490 280n
preplace netloc axi_ethernet_0_phy_rst_n 1 5 1 NJ 250
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 6 30 910 NJ 910 NJ 910 NJ 910 NJ 910 1960
preplace netloc rst_ps7_0_100M_peripheral_aresetn 1 1 4 380 630 710 350 1110 390 1410J
preplace netloc sys_clock_1 1 0 4 NJ 510 NJ 510 NJ 510 NJ
preplace netloc processing_system7_0_DDR 1 5 1 NJ 670
preplace netloc processing_system7_0_FIXED_IO 1 5 1 NJ 690
preplace netloc axi_ethernet_0_dma_M_AXIS_MM2S 1 3 2 1090 30 1490J
preplace netloc axi_ethernet_0_dma_M_AXIS_CNTRL 1 3 2 1070 10 1500J
preplace netloc axi_ethernet_0_m_axis_rxs 1 2 4 720 590 NJ 590 NJ 590 1970
preplace netloc axi_ethernet_0_m_axis_rxd 1 2 4 720 20 NJ 20 NJ 20 1970
preplace netloc axi_ethernet_0_mdio 1 5 1 NJ 170
preplace netloc axi_ethernet_0_gmii 1 5 1 NJ 190
preplace netloc processing_system7_0_M_AXI_GP0 1 1 5 390 610 NJ 610 NJ 610 NJ 610 1970
preplace netloc ps7_0_axi_periph_M00_AXI 1 2 3 NJ 760 NJ 760 1450
preplace netloc ps7_0_axi_periph_M01_AXI 1 2 1 700 110n
preplace netloc axi_ethernet_0_dma_M_AXI_MM2S 1 3 1 1060 90n
preplace netloc axi_mem_intercon_M00_AXI 1 4 1 1430 210n
preplace netloc axi_ethernet_0_dma_M_AXI_S2MM 1 3 1 1100 110n
preplace netloc axi_ethernet_0_dma_M_AXI_SG 1 3 1 1110 80n
levelinfo -pg 1 0 200 540 890 1260 1730 1990
pagesize -pg 1 -db -bbox -sgen -120 0 2110 1110
"
}
  ...
  set_property PFM_NAME {xilinx:zedboard:VideoPlatform:0.0} [get_files [current_bd_design].bd]
  set_property PFM.CLOCK {FCLK_CLK0 {id "33" is_default "true" proc_sys_reset "/rst_ps7_0_100M" status "fixed" freq_hz "100000000"}} [get_bd_cells /processing_system7_0]
...
# End of cr_bd_Licenta_Design()

cr_bd_Licenta_Design ""
set_property EXCLUDE_DEBUG_LOGIC "0" [get_files Licenta_Design.bd ] 
set_property GENERATE_SYNTH_CHECKPOINT "1" [get_files Licenta_Design.bd ] 
set_property IS_ENABLED "1" [get_files Licenta_Design.bd ] 
set_property IS_GLOBAL_INCLUDE "0" [get_files Licenta_Design.bd ] 
set_property LIBRARY "xil_defaultlib" [get_files Licenta_Design.bd ] 
set_property PATH_MODE "RelativeFirst" [get_files Licenta_Design.bd ] 
set_property PFM_NAME "xilinx:zedboard:VideoPlatform:0.0" [get_files Licenta_Design.bd ] 
set_property REGISTERED_WITH_MANAGER "1" [get_files Licenta_Design.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files Licenta_Design.bd ] 
set_property USED_IN "synthesis implementation simulation" [get_files Licenta_Design.bd ] 
set_property USED_IN_IMPLEMENTATION "1" [get_files Licenta_Design.bd ] 
set_property USED_IN_SIMULATION "1" [get_files Licenta_Design.bd ] 
set_property USED_IN_SYNTHESIS "1" [get_files Licenta_Design.bd ] 

#call make_wrapper to create wrapper files
if { [get_property IS_LOCKED [ get_files -norecurse [list Licenta_Design.bd]] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/LicentaStagii/6_GPIO/Vivado/project_1.gen/sources_1/bd/Licenta_Design/hdl/Licenta_Design_wrapper.v" ]
} else {
  set wrapper_path [make_wrapper -fileset sources_1 -files [ get_files -norecurse [list Licenta_Design.bd]] -top]
...
set_property -name "incremental_checkpoint" -value "$proj_dir/${_xil_proj_name_}.srcs/utils_1/imports/synth_1/Licenta_Design_wrapper.dcp" -objects $obj
